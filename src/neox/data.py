"""
---
title: Datasets for GPT-NeoX
summary: >
    Loads text datasets to fine-tune GPT-NeoX
---

# Datasets for GPT-NeoX
"""
...
def get_training_data(seq_len: int = 32, dataset_name: str = 'tiny_shakespeare'):
    """
    ### Load Dataset
    ...
    #
    return NeoXDataset(tokens.ids, seq_len)
